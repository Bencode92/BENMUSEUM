...
Ce Worker garde ta **clé Claude** en secret et permet au musée déployé (GitHub Pages)
...
## Brancher le musée
Dans le musée en ligne, ouvre une fiche d'œuvre → **« Configurer l'IA en ligne »**
