/* =========================================================================
   Mini-serveur du Musée de l'Histoire de l'Art
  ...
  req.on("end", async () => {
    try {
      ...
      const ctxLines = [
        ...
        work ? `Œuvre devant le visiteur : « ${work.titre} » — ${work.artiste}, ${work.annee}. ${work.note}` : "",
      ].filter(Boolean).join("\n");

      const system =
        "Tu es le guide d'un musée virtuel d'histoire de l'art, dans l'esprit de Gombrich : " +
        "tu expliques ce que chaque artiste cherchait à résoudre, sans jargon, avec chaleur et précision. " +
